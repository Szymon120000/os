...
PRIVACY_OBJ := $(BUILD_DIR)\privacy.obj
...
$(PRIVACY_OBJ): src\privacy.c src\privacy.h src\efi_min.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c src/privacy.c -o $(PRIVACY_OBJ)

$(EFI_BIN): $(EFI_OBJ) $(GFX_OBJ) $(GUI_OBJ) $(EXU_OBJ) $(PRIVACY_OBJ)
	$(LDLINK) $(LDFLAGS) $(EFI_OBJ) $(GFX_OBJ) $(GUI_OBJ) $(EXU_OBJ) $(PRIVACY_OBJ)
